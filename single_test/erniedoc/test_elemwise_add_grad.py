...
x = np.random.uniform(0.1, 0.9, (4, 512, 768))
y = np.random.uniform(0.1, 0.9, (4, 512, 768))
...
out_pd = paddle.fluid.layers.elementwise_add(pd_x, pd_y)
pd_res = out_pd.numpy()
out_pd.backward()
pd_dx = pd_x.grad
pd_dy = pd_y.grad
